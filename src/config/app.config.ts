...
export default registerAs('app', () => ({
  ...
  enableReplicaDbAccess: getConfigValueBoolean(
    'EASEY_EMISSIONS_API_ENABLE_REPLICA_DB_ACCESS',
  ),
  ...
  contentApi: {
    uri: getConfigValue(
      'EASEY_CONTENT_API', `https://${apiHost}/content-mgmt`,
    ),
  },
  ...
  enableAuditLog: getConfigValueBoolean('EASEY_EMISSIONS_API_ENABLE_AUDIT_LOG', true)
}));
