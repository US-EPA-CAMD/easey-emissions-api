...
export const getErrorMessage = (property, value) => `You reported an invalid ${property} of ${value}.`;


export const getInvalidCodes = async ( codeSet: Set<string>, entityRepo: Repository<BaseEntity>) => {
...
export const getCodeFieldRepoList = (): CodeFieldRepo[] =>{
    return ([
        ...
        {
            codeField: "apsCode",
            codeRepo: ApsCode.getRepository()
        },
        {
